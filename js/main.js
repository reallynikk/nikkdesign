/* ==========================================================================
   ...
   Theme: Monochrome — Inter × Playfair Display
   ========================================================================== */
...
function initAuraCanvas() {
  ...
  const blobs = [
    { x: width * 0.25, y: height * 0.3, r: 480, color: 'rgba(255, 255, 255, 0.05)', vx: 1.0, vy: 0.6, phase: 0 },
    { x: width * 0.75, y: height * 0.7, r: 520, color: 'rgba(255, 255, 255, 0.04)', vx: -0.8, vy: -0.5, phase: 2.1 },
    { x: width * 0.5, y: height * 0.5, r: 400, color: 'rgba(255, 255, 255, 0.035)', vx: 0.6, vy: -0.9, phase: 4.2 }
  ];
...
function initCoverflowShowcase() {
  ...
  function updateCardPositions() {
    ...
    updateTaglineFromCard(cards[centerIdx]);
  }
...
/* --------------------------------------------------------------------------
   10. COVERFLOW TAGLINE UPDATER (Monochrome — no dynamic color themes)
   -------------------------------------------------------------------------- */
function updateTaglineFromCard(card) {
  const topTaglineEl = document.getElementById('coverflowTopTagline');
  if (!card || !topTaglineEl) return;
